      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-white">Recent lists</h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {sortedLists.map((list) => (
              <div
                key={list.id}
                className="flex h-full flex-col justify-between rounded-2xl border border-[var(--app-border-strong)]/40 bg-[var(--app-surface)] p-5 shadow-sm"
              >
                ...
                <div className="mt-4 flex items-center justify-between text-sm">
                  <span className="text-xs text-[var(--app-muted)]">Created {formatDate(list.createdAt)}</span>
                  <Link
                    className="rounded-lg border border-[var(--app-border-strong)] px-3 py-2 text-xs font-semibold text-white transition-colors hover:border-[var(--app-primary)]"
